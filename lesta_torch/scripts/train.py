...
from lesta.api.model import TraversabilityModel
from utils.train import seed, machine
...
def main(args):
    ...
    yaml = yaml_tools.load_config(config_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='lesta_config.yaml')
